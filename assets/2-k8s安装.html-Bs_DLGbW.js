import{_ as n,c as a,e,o as l}from"./app-zVz4Ppvc.js";const i={};function t(c,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="kubernetes-k8s-安装与核心组件详解" tabindex="-1"><a class="header-anchor" href="#kubernetes-k8s-安装与核心组件详解"><span>Kubernetes（K8s）安装与核心组件详解</span></a></h1><blockquote><p>① 参考资料汇总 ② 核心组件详解 ③ 集群安装步骤 ④ 常见工具与网络插件配置</p></blockquote><hr><h2 id="_0-参考资料" tabindex="-1"><a class="header-anchor" href="#_0-参考资料"><span>0. 参考资料</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">1. k8s能干什么</span>
