import{_ as n,c as a,e,o as l}from"./app-zVz4Ppvc.js";const i={};function p(c,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="redis主从哨兵高可用与安全配置指南" tabindex="-1"><a class="header-anchor" href="#redis主从哨兵高可用与安全配置指南"><span>Redis主从哨兵高可用与安全配置指南</span></a></h1><h2 id="一、redis主从复制架构" tabindex="-1"><a class="header-anchor" href="#一、redis主从复制架构"><span>一、Redis主从复制架构</span></a></h2><h3 id="_1-1-主从复制概述" tabindex="-1"><a class="header-anchor" href="#_1-1-主从复制概述"><span>1.1 主从复制概述</span></a></h3><p>Redis提供主从库模式保证数据副本一致性，采用读写分离方式：</p><ul><li>主库：负责写操作</li><li>从库：负责读操作，自动同步主库数据</li></ul><h3 id="_1-2-主从配置部署" tabindex="-1"><a class="header-anchor" href="#_1-2-主从配置部署"><span>1.2 主从配置部署</span></a></h3><h4 id="主节点配置-db-51" tabindex="-1"><a class="header-anchor" href="#主节点配置-db-51"><span>主节点配置（db-51）</span></a></h4><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token function">cat</span> <span class="token operator">&gt;</span> /etc/redis.conf <span class="token operator">&lt;&lt;</span><span class="token string">&#39;EOF&#39;</span>
