import{_ as n,c as a,e,o as l}from"./app-zVz4Ppvc.js";const i={};function t(p,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="自动化发布静态网站-ci-cd实践指南" tabindex="-1"><a class="header-anchor" href="#自动化发布静态网站-ci-cd实践指南"><span>自动化发布静态网站 - CI/CD实践指南</span></a></h1><h2 id="一、项目概述" tabindex="-1"><a class="header-anchor" href="#一、项目概述"><span>一、项目概述</span></a></h2><h3 id="_1-1-项目目标" tabindex="-1"><a class="header-anchor" href="#_1-1-项目目标"><span>1.1 项目目标</span></a></h3><p>实现从代码提交到自动化部署的完整CI/CD流水线，通过Jenkins将静态网站一键部署到多台Web服务器。</p><h3 id="_1-2-技术架构" tabindex="-1"><a class="header-anchor" href="#_1-2-技术架构"><span>1.2 技术架构</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">开发人员 → GitLab代码仓库 → Jenkins自动化构建 → 多台Web服务器</span>
