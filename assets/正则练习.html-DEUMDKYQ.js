import{_ as n,c as a,e,o as l}from"./app-zVz4Ppvc.js";const p={};function i(t,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h2 id="一、正则表达式练习" tabindex="-1"><a class="header-anchor" href="#一、正则表达式练习"><span>一、正则表达式练习</span></a></h2><ul><li>基本正则表达式（BRE）</li><li>扩展正则表达式（ERE）</li><li>结合grep、sed命令的用法</li></ul><h2 id="二、测试数据" tabindex="-1"><a class="header-anchor" href="#二、测试数据"><span>二、测试数据</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">I am teacher yuchao.</span>
