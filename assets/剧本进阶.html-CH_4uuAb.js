import{_ as n,c as a,e,o as l}from"./app-zVz4Ppvc.js";const t={};function p(i,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h2 id="一、playbook-高级特性概述" tabindex="-1"><a class="header-anchor" href="#一、playbook-高级特性概述"><span>一、Playbook 高级特性概述</span></a></h2><h3 id="_1-1-为什么需要高级特性" tabindex="-1"><a class="header-anchor" href="#_1-1-为什么需要高级特性"><span>1.1 为什么需要高级特性</span></a></h3><ul><li><strong>简化剧本编写</strong>：避免重复代码</li><li><strong>提高可维护性</strong>：结构化、模块化</li><li><strong>增强灵活性</strong>：条件执行、循环控制</li><li><strong>编程逻辑</strong>：变量、循环、条件判断等编程特性</li></ul><h3 id="_1-2-两种任务参数写法对比" tabindex="-1"><a class="header-anchor" href="#_1-2-两种任务参数写法对比"><span>1.2 两种任务参数写法对比</span></a></h3><div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml"><pre><code class="language-yaml"><span class="line"><span class="token comment"># 写法1：字典风格（推荐，符合YAML标准）</span></span>
