import{_ as n,c as a,e,o as l}from"./app-zVz4Ppvc.js";const p={};function i(t,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="shell-函数完全指南" tabindex="-1"><a class="header-anchor" href="#shell-函数完全指南"><span>Shell 函数完全指南</span></a></h1><h2 id="一、函数基础" tabindex="-1"><a class="header-anchor" href="#一、函数基础"><span>一、函数基础</span></a></h2><h3 id="_1-1-为什么使用函数" tabindex="-1"><a class="header-anchor" href="#_1-1-为什么使用函数"><span>1.1 为什么使用函数</span></a></h3><ul><li><strong>代码复用</strong>：避免重复编写相同代码</li><li><strong>结构清晰</strong>：让脚本更易读、易维护</li><li><strong>模块化</strong>：分解复杂脚本为小功能块</li></ul><h3 id="_1-2-函数定义语法" tabindex="-1"><a class="header-anchor" href="#_1-2-函数定义语法"><span>1.2 函数定义语法</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 方式1：推荐写法</span></span>
