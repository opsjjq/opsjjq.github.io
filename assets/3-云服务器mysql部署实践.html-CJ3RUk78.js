import{_ as n,c as a,e,o as l}from"./app-zVz4Ppvc.js";const i={};function p(c,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="云服务器-mysql-操作手册" tabindex="-1"><a class="header-anchor" href="#云服务器-mysql-操作手册"><span>云服务器 MySQL 操作手册</span></a></h1><h2 id="一、删除旧版-mysql" tabindex="-1"><a class="header-anchor" href="#一、删除旧版-mysql"><span>一、删除旧版 MySQL</span></a></h2><h3 id="_1-1-执行删除脚本" tabindex="-1"><a class="header-anchor" href="#_1-1-执行删除脚本"><span>1.1 执行删除脚本</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 创建删除脚本</span></span>
