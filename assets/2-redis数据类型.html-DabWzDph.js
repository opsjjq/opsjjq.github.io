import{_ as n,c as a,e,o as l}from"./app-zVz4Ppvc.js";const t={};function i(p,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h2 id="一、redis-数据存储格式" tabindex="-1"><a class="header-anchor" href="#一、redis-数据存储格式"><span>一、Redis 数据存储格式</span></a></h2><p>Redis 采用键值对（key-value）形式存储数据：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">key : value</span>
