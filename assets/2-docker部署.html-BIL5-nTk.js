import{_ as n,c as a,e,o as l}from"./app-zVz4Ppvc.js";const i={};function p(c,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="docker-安装部署指南" tabindex="-1"><a class="header-anchor" href="#docker-安装部署指南"><span>Docker 安装部署指南</span></a></h1><h2 id="一、安装前准备" tabindex="-1"><a class="header-anchor" href="#一、安装前准备"><span>一、安装前准备</span></a></h2><h3 id="配置内核参数-必需" tabindex="-1"><a class="header-anchor" href="#配置内核参数-必需"><span>配置内核参数（必需）</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 创建配置文件</span></span>
