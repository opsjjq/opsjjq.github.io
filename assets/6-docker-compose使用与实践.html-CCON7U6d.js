import{_ as n,c as a,e,o as l}from"./app-zVz4Ppvc.js";const p={};function i(t,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="docker-compose-使用与实践" tabindex="-1"><a class="header-anchor" href="#docker-compose-使用与实践"><span>Docker Compose 使用与实践</span></a></h1><h2 id="一、docker-compose-安装与基础" tabindex="-1"><a class="header-anchor" href="#一、docker-compose-安装与基础"><span>一、Docker Compose 安装与基础</span></a></h2><h3 id="安装方法" tabindex="-1"><a class="header-anchor" href="#安装方法"><span>安装方法</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 下载最新版 Docker Compose</span></span>
