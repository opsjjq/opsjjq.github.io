import{_ as n,c as a,e,o as l}from"./app-zVz4Ppvc.js";const i={};function p(r,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="sonarqube-代码质量扫描与-jenkins-集成部署指南" tabindex="-1"><a class="header-anchor" href="#sonarqube-代码质量扫描与-jenkins-集成部署指南"><span>SonarQube 代码质量扫描与 Jenkins 集成部署指南</span></a></h1><h2 id="一、软件开发流水线概述" tabindex="-1"><a class="header-anchor" href="#一、软件开发流水线概述"><span>一、软件开发流水线概述</span></a></h2><p>在 DevOps 运维流水线中，代码质量扫描是测试环节的重要组成部分：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">开发 → 测试 → 运维</span>
