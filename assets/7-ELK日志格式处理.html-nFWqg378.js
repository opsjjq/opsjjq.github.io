import{_ as n,c as a,e,o as l}from"./app-zVz4Ppvc.js";const t={};function i(p,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="elk日志格式处理" tabindex="-1"><a class="header-anchor" href="#elk日志格式处理"><span>ELK日志格式处理</span></a></h1><h2 id="一、json格式日志处理" tabindex="-1"><a class="header-anchor" href="#一、json格式日志处理"><span>一、JSON格式日志处理</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">修改Nginx配置为JSON格式（推荐，简单高效）</span>
